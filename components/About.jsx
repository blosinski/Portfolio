      ...
      <div className="max-w-[1240px] m-auto md:grid grid-cols-3 gap-8">
        <div className="col-span-2">
          ...
          <p className="py-2 text-gray-600">
            Hello, my name is Brendan and I am an iOS Engineer who loves
            creating mobile apps! My interest in Mobile Development started back
            in 2018 when I started looking into how apps were created. I have
            been learning ever since and now I have a passion for developing
            high quality mobile applications that provide an excellent user
